// Debe tener "../" para subir un nivel y encontrar la carpeta components
...
// 1. AGREGA ESTA DATA AQUÍ (Es lo que le falta a tu código)
const TOURS_DATA = [
  {
    id: 1,
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-inter">
      ...
      <main className="pt-16">
        ...
        {/* SECCIÓN DE TOURS: Ahora con data definida */}
        <section id="tours" className="py-20 container mx-auto px-6">
