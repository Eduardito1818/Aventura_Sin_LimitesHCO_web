    ...
    <>
      ...
      {loading ? (
        ...
        <BrowserRouter>
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-whatsapp"><path d="M8.27 15.67a6.29 6.29 0 0 0 2.21 2.21l1.65-1.65a1 1 0 0 1 1.25-.26c.26.11.53.2.8.27l1.83.45c.42.1.86-.01 1.15-.29.29-.29.39-.73.29-1.15l-.45-1.83a1.07 1.07 0 0 1 .26-1.25l1.65-1.65a6.29 6.29 0 0 0 2.2-2.2L20.2 4.07a1 1 0 0 0-.7-.7h-3.41l-2.09 5.82a1.44 1.44 0 0 1-2.45.54l-1.3-1.3a1.44 1.44 0 0 1-.54-2.45L4.07 4.07a1 1 0 0 0-.7.7l.95 2.87c.78 2.34 2.1 4.29 3.86 6.05l.38.39z"/><path d="M11.66 16.89a6.29 6.29 0 0 0 2.21 2.21l1.65-1.65a1 1 0 0 1 1.25-.26c.26.11.53.2.8.27l1.83.45c.42.1.86-.01 1.15-.29.29-.29.39-.73.29-1.15l-.45-1.83a1.07 1.07 0 0 1 .26-1.25l1.65-1.65a6.29 6.29 0 0 0 2.2-2.2L20.2 4.07a1 1 0 0 0-.7-.7h-3.41l-2.09 5.82a1.44 1.44 0 0 1-2.45.54l-1.3-1.3a1.44 1.44 0 0 1-.54-2.45L4.07 4.07a1 1 0 0 0-.7.7l.95 2.87c.78 2.34 2.1 4.29 3.86 6.05l.38.39z"/></svg>
          </a>
        </BrowserRouter>
      )}
    </>
